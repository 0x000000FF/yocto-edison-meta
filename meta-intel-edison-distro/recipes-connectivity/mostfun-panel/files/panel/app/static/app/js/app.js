...
(function ($, window, document) {
    ...
    $(function () {
        ...
        /* From BS-Doc: All dropdown events are fired at the .dropdown-menu's parent element. */
...
//    $('#upload-select').click(function () {
    $(function () {
        var attr_action = $('#upload-select').attr('target-view');
        ...
        var progressbar = $("#progressbar"),
            ...
            settings = {
                ...
                //allow: '*.(gcode|stl|obj|jpg|jpeg|png|gif|zip|7z|rar|tar|gz|bz2)', // allow only images
                ...
                allcomplete: function (response) {
                    ...
                    //if (response.msg.split('.').pop() == 'gcode') {
                        getfilelistmin();
                    //}
                }
            };
