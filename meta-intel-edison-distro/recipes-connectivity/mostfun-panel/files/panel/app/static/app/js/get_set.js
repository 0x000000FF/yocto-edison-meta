        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                setTimeout(function() {
                    ...
                    $.getScript('static/3dv/Detector.js');

                    $.getScript('static/vendor/parsley/parsley.min.js');
                    $.getScript('static/app/js/International/setting.js');
                    $.getScript('static/app/js/settings/password.js');
                    $.getScript('static/app/js/settings/frimware.js');
                    $.getScript('static/app/js/settings/wireless.js');
                    $.getScript('static/app/js/settings/language.js');
