...
(function (t) {
    ...
    function s(n, r) {
        ...
        function p(e) {
            me++, se && (Q("viewDestroy", se, se, se.element), Y(), se.triggerEventDestroy(), $(), se.element.remove(), re.deactivateButton(se.name)), re.activateButton(e), se = new Re[e](t("<div class='fc-view fc-view-" + e + "' />").appendTo(oe), J), m(), V(), me--
        }

        function m(t) {
            se.start && !t && de.isWithin(se.intervalStart, se.intervalEnd) || f() && g(t)
        }

        function g(t) {
            me++, se.start && (Q("viewDestroy", se, se, se.element), Y(), x()), $(), t && (de = se.incrementDate(de, t)), se.render(de.clone()), w(), V(), (se.afterRender || k)(), F(), N(), Q("viewRender", se, se, se.element), me--, M()
        }
        ...
        function w() {
            void 0 === ce && b(), me++, se.setHeight(ce), se.setWidth(oe.width()), me--, le = n.outerWidth()
        }
        ...
        function D() {
            if (!me)if (se.start) {
                var t = ++pe;
                setTimeout(function () {
                    t == pe && !me && f() && le != (le = n.outerWidth()) && (me++, y(), se.trigger("windowResize", he), me--)
                }, 200)
            } else s()
        }
        ...
        function S(t) {
            f() && (se.renderEvents(ge, t), se.trigger("eventAfterAllRender"))
        }
        ...
        J.defaultAllDayEventDuration = e.duration(te.defaultAllDayEventDuration), J.defaultTimedEventDuration = e.duration(te.defaultTimedEventDuration), J.moment = function () {
            var t;
            return "local" === te.timezone ? (t = _e.moment.apply(null, arguments), t.hasTime() && t.local()) : t = "UTC" === te.timezone ? _e.moment.utc.apply(null, arguments) : _e.moment.parseZone.apply(null, arguments), t._lang = ee, t
            ...
            return "function" == typeof n && (n = n.call(J, te, ee)), I(t, e, n, null, te.isRTL)
        }, J.formatDate = function (t, e) {
            return "function" == typeof e && (e = e.call(J, te, ee)), B(t, e)
        }, c.call(J, te);
        var re, ae, oe, ie, se, le, ce, de, ue, fe = J.isFetchNeeded, ve = J.fetchEvents, he = n[0], pe = 0, me = 0, ge = [];
                ...
                t.each(this.split(","), function (r, i) {
                    if ("title" == i)a.append("<span class='fc-header-title'><h2>&nbsp;</h2></span>"), o && o.addClass(f + "-corner-right"), o = null; else {
                        ...
                        if (e[i] ? s = e[i] : Re[i] && (s = function () {
                            ...
                            F(h), o || h.addClass(f + "-corner-left"), o = h
                        }
                    }
    ...
    function c(e) {
        ...
        function o(n, r) {
            ...
            var l = n.events;
            if (l)t.isFunction(l) ? (m(), l.call(E, S.clone(), k.clone(), e.timezone, function (t) {
                r(t), g()
                ...
                if (c) {
                    ...
                    var h = t.extend({}, d || {}), p = A(n.startParam, e.startParam), y = A(n.endParam, e.endParam), b = A(n.timezoneParam, e.timezoneParam);
                    p && (h[p] = S.format()), y && (h[y] = k.format()), e.timezone && "local" != e.timezone && (h[b] = e.timezone), m(), t.ajax(t.extend({}, Fe, n, {
                        data: h,
                        success: function (e) {
                            e = e || [];
        ...
        function c(t) {
            t.start = E.moment(t.start), t.end && (t.end = E.moment(t.end)), b(t), u(t), z(W)
        }

        function u(t) {
            var e, n, r, a;
            for (e = 0; W.length > e; e++)if (n = W[e], n._id == t._id && n !== t)for (r = 0; B.length > r; r++)a = B[r], void 0 !== t[a] && (n[a] = t[a])
        }

        function f(t, e) {
            var n = y(t);
            n && (n.source || (e && (R.events.push(n), n.source = R), W.push(n)), z(W))
        }
        ...
        function w(n, r, a, o, i) {
            ...
            return t.each(n, function (t, n) {
                ...
                v ? (h.stripTime(), p && p.stripTime()) : (h.hasTime() || (h = E.rezoneDate(h)), p && !p.hasTime() && (p = E.rezoneDate(p))), p || !e.forceEventDuration && !+i || (p = E.getDefaultEventEnd(v, h)), h.add(o), p && p.add(o).add(i), s && (+o || +i) && (h.stripZone(), p && p.stripZone()), n.allDay = v, n.start = h, n.end = p, d(n), l.push(function () {
        ...
        var S, k, x = E.trigger, M = E.getView, z = E.reportEvents, _ = E.getEventEnd, R = {events: []}, F = [R], N = 0, H = 0, O = 0, W = [], L = e.eventSources || [];
        e.events && L.push(e.events);
        for (var Z = 0; L.length > Z; Z++)s(L[Z]);
        var B = ["title", "url", "allDay", "className", "editable", "color", "backgroundColor", "borderColor", "textColor"]
    }
    ...
    function O(n, r, a) {
        ...
        return e.isMoment(c) ? (l = e.apply(null, n), c._ambigTime && (l._ambigTime = !0), c._ambigZone && (l._ambigZone = !0)) : h(c) || void 0 === c ? l = e.apply(null, n) : (o = !1, i = !1, d ? Ye.test(c) ? (c += "-01", n = [c], o = !0, i = !0) : (s = Ae.exec(c)) && (o = !s[5], i = !0) : t.isArray(c) && (i = !0), l = r ? e.utc.apply(e, n) : e.apply(null, n), o ? (l._ambigTime = !0, l._ambigZone = !0) : a && (i ? l._ambigZone = !0 : d && l.zone(c))), new W(l)
    }
    ...
    function I(t, e, n, r, a) {
        return t = _e.moment.parseZone(t), e = _e.moment.parseZone(e), n = t.lang().longDateFormat(n) || n, r = r || " - ", q(t, e, V(n), r, a)
    }
    ...
    function J(e, n, r) {
        ...
        function s() {
            var n = l();
            Y && Y.remove(), Y = t(n).appendTo(e), A = Y.find("thead"), O = A.find(".fc-day-header"), W = Y.find("tbody"), L = W.find("tr"), Z = W.find(".fc-day"), B = L.find("td:first-child"), P = L.eq(0).find(".fc-day > div"), j = L.eq(0).find(".fc-day-content > div"), N(A.add(A.find("tr"))), N(L), L.eq(0).addClass("fc-first"), L.filter(":last").addClass("fc-last"), Z.each(function (e, n) {
                var r = ue(Math.floor(e / G), e % G);
                se("dayRender", H, r, t(n))
            }), h(Z)
        }
        ...
        function c() {
            ...
            for (r += "<thead><tr>", oe && (r += "<th class='fc-week-number " + n + "'>" + _(ie("weekNumberTitle")) + "</th>"), t = 0; G > t; t++)e = ue(0, t), r += "<th class='fc-day-header fc-" + He[e.day()] + " " + n + "'>" + _(he(e, ae)) + "</th>";
            return r += "</tr></thead>"
        }
        ...
        function d() {
            ...
            for (a += "<tbody>", t = 0; U > t; t++) {
                for (a += "<tr class='fc-week'>", oe && (n = ue(t, 0), a += "<td class='fc-week-number " + r + "'>" + "<div>" + _(pe(n)) + "</div>" + "</td>"), e = 0; G > e; e++)n = ue(t, e), a += u(n);
                a += "</tr>"
            }
            return a += "</tbody>"
        }
        ...
        function u(t) {
            var e = H.intervalStart.month(), r = n.getNow().stripTime(), a = "", o = re + "-widget-content", i = ["fc-day", "fc-" + He[t.day()], o];
        ...
        function v(t) {
            q = t, ee.clear(), ne.clear(), X = 0, oe && (X = A.find("th.fc-week-number").outerWidth()), V = Math.floor((q - X) / G), m(O.slice(0, -1), V)
        }
        ...
        var H = this;
        H.renderBasic = a, H.setHeight = f, H.setWidth = v, H.renderDayOverlay = g, H.defaultSelectionEnd = b, H.renderSelection = w, H.clearSelection = D, H.reportDayClick = C, H.dragStart = E, H.dragStop = S, H.getHoverListener = function () {
            return te
        }, H.colLeft = k, H.colRight = x, H.colContentLeft = M, H.colContentRight = z, H.getIsCellAllDay = function () {
            return !0
        }, H.allDayRow = R, H.getRowCnt = function () {
            return U
            ...
            return I
        }, me.call(H, e, n, r), Te.call(H), De.call(H), K.call(H);
        var Y, A, O, W, L, Z, B, P, j, I, q, $, V, X, U, G, Q, J, te, ee, ne, re, ae, oe, ie = H.opt, se = H.trigger, le = H.renderOverlay, ce = H.clearOverlays, de = H.daySelectionMousedown, ue = H.cellToDate, fe = H.dateToCell, ve = H.rangeToSegments, he = n.formatDate, pe = n.calculateWeekNumber;
        F(e.addClass("fc-grid")), J = new Ce(function (e, n) {
            var r, a, o;
            O.each(function (e, i) {
    ...
    function K() {
        ...
        var n = this;
        n.renderEvents = t, n.clearEvents = e, ge.call(n)
    }
    ...
    function ae(n, r, a) {
        ...
        function d() {
            ...
            for (a += "<thead><tr>", Le("weekNumbers") ? (t = Ve(0, 0), e = Qe(t), Ye ? e += Le("weekNumberTitle") : e = Le("weekNumberTitle") + e, a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + _(e) + "</th>") : a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>", n = 0; xe > n; n++)t = Ve(0, n), a += "<th class='fc-" + He[t.day()] + " fc-col" + n + " " + r + "'>" + _(Ge(t, We)) + "</th>";
        ...
        function u() {
            ...
            for (c += "<tbody><tr><th class='fc-agenda-axis " + i + "'>&nbsp;</th>", n = "", e = 0; xe > e; e++)t = Ve(0, e), o = ["fc-col" + e, "fc-" + He[t.day()], s], t.isSame(l, "day") ? o.push(Ne + "-state-highlight", "fc-today") : l > t ? o.push("fc-past") : o.push("fc-future"), a = "<td class='" + o.join(" ") + "'>" + "<div>" + "<div class='fc-day-content'>" + "<div style='position:relative'>&nbsp;</div>" + "</div>" + "</div>" + "</td>", n += a;
        ...
        function f(t) {
            ...
            ye = (a + o) / 2, we = ge / be, Se = ye / we
        }

        function v(e) {
            ue = e, Re.clear(), Fe.clear();
            var n = V.find("th:first");
            re && (n = n.add(re.find("th:first"))), n = n.add(ce.find("th:first")), ve = 0, m(n.width("").each(function (e, n) {
                ve = Math.max(ve, t(n).outerWidth())
            }), ve);
            var r = $.find(".fc-agenda-gutter");
            re && (r = r.add(re.find("th.fc-agenda-gutter")));
            var a = ie[0].clientWidth;
            pe = ie.width() - a, pe ? (m(r, pe), r.show().prev().removeClass("fc-last")) : r.hide().prev().addClass("fc-last"), he = Math.floor((a - ve) / xe), m(X.slice(0, -1), he)
        }
        ...
        function w(t) {
            if (!Le("selectable")) {
                ...
                if (a) {
                    ...
                    n.add(Ae + o * ge), n = r.rezoneDate(n), Ze("dayClick", G[e], n, t)
        ...
        function E(t, e) {
            ...
            for (var n = 0; xe > n; n++) {
                ...
                if (i > o) {
                    var s = ze.rect(0, n, 0, n, se), l = Y(o, r), c = Y(i, r);
        ...
        function H(t) {
            ...
            return Le("allDaySlot") && a--, a >= 0 && (n.time(e.duration(Ae + a * be)), n = r.rezoneDate(n)), n
        }
        ...
        function A(t) {
            ...
            var e = (t - Ae) / ge, n = Math.floor(e), r = e - n, a = Je[n];
        ...
        function L(e, n) {
            ...
            if (ze.build(), r) {
                var a = Xe(e).col;
                if (a >= 0 && xe > a) {
                    var o = ze.rect(0, a, 0, a, se), i = Y(e, e), s = Y(n, e);
                    if (s > i) {
                        ...
                        de && (b(de), se.append(de), m(de, o.width, !0), g(de, o.height, !0))
                    }
                }
            } else E(e, n)
        }
        ...
        function I(t, e, n) {
            var r = _e.stop();
            Pe(), r && Ze("drop", t, H(r), e, n)
        }

        var q = this;
        q.renderAgenda = o, q.setWidth = v, q.setHeight = f, q.afterRender = p, q.computeDateTop = Y, q.getIsCellAllDay = R, q.allDayRow = function () {
            return ae
            ...
            return Oe
        }, q.defaultSelectionEnd = O, q.renderDayOverlay = D, q.renderSelection = W, q.clearSelection = Z, q.reportDayClick = P, q.dragStart = j, q.dragStop = I, me.call(q, n, r, a), Te.call(q), De.call(q), oe.call(q);
        ...
        F(n.addClass("fc-agenda")), ze = new Ce(function (e, n) {
            function r(t) {
            ...
            for (var s = se.offset().top, l = ie.offset().top, c = l + ie.outerHeight(), d = 0; Me * we > d; d++)e.push([r(s + Se * d), r(s + Se * (d + 1))])
        }), _e = new Ee(ze), Re = new ke(function (t) {
            return Q.eq(t)
        }), Fe = new ke(function (t) {
            return J.eq(t)
        })
    }
    ...
    function oe() {
        ...
        function a(t) {
            ...
            for (n = 0; s > n; n++)for (e = R(0, n), i = o(t, e.clone().time(l), e.clone().time(c)), i = ie(i), r = 0; i.length > r; r++)a = i[r], a.col = n, d.push(a);
            return d
        }
        ...
        function i(e, n) {
            var r, a, o, i, c, d, u, f, m, g, b, w, D, C, S, x, _ = e.length, R = "", F = E(), N = v("isRTL");
            for (r = 0; _ > r; r++)a = e[r], o = a.event, i = k(a.start, a.start), c = k(a.end, a.start), d = M(a.col), u = z(a.col), f = u - d, u -= .025 * f, f = u - d, m = f * (a.forwardCoord - a.backwardCoord), v("slotEventOverlap") && (m = Math.max(2 * (m - 10), m)), N ? (b = u - a.backwardCoord * f, g = b - m) : (g = d + a.backwardCoord * f, b = g + m), g = Math.max(g, d), b = Math.min(b, u), m = b - g, a.top = i, a.left = g, a.outerWidth = m, a.outerHeight = c - i, R += s(o, a);
            for (F[0].innerHTML = R, w = F.children(), r = 0; _ > r; r++)a = e[r], o = a.event, D = t(w[r]), C = h("eventRender", o, o, D), C === !1 ? D.remove() : (C && C !== !0 && (D.remove(), D = t(C).css({
                position: "absolute",
                top: a.top,
                left: a.left
            }).appendTo(F)), a.element = D, o._id === n ? l(o, D, a) : D[0]._fci = r, Z(o, D));
            for (p(F, e, l), r = 0; _ > r; r++)a = e[r], (D = a.element) && (a.vsides = T(D, !0), a.hsides = y(D, !0), S = D.find(".fc-event-title"), S.length && (a.contentTop = S[0].offsetTop));
            for (r = 0; _ > r; r++)a = e[r], (D = a.element) && (D[0].style.width = Math.max(0, a.outerWidth - a.hsides) + "px", x = Math.max(0, a.outerHeight - a.vsides), D[0].style.height = x + "px", o = a.event, void 0 !== a.contentTop && 10 > x - a.contentTop && (D.find("div.fc-event-time").text(Q(o.start, v("timeFormat")) + " - " + o.title), D.find("div.fc-event-title").remove()), h("eventAfterRender", o, o, D))
        }

        function s(t, e) {
            var n = "<", r = t.url, a = H(t, v), o = ["fc-event", "fc-event-vert"];
            return m(t) && o.push("fc-event-draggable"), e.isStart && o.push("fc-event-start"), e.isEnd && o.push("fc-event-end"), o = o.concat(t.className), t.source && (o = o.concat(t.source.className || [])), n += r ? "a href='" + _(t.url) + "'" : "div", n += " class='" + o.join(" ") + "'" + " style=" + "'" + "position:absolute;" + "top:" + e.top + "px;" + "left:" + e.left + "px;" + a + "'" + ">" + "<div class='fc-event-inner'>" + "<div class='fc-event-time'>", n += t.end ? _(J(t.start, t.end, v("timeFormat"))) : _(Q(t.start, v("timeFormat"))), n += "</div><div class='fc-event-title'>" + _(t.title || "") + "</div>" + "</div>" + "<div class='fc-event-bg'></div>", e.isEnd && b(t) && (n += "<div class='ui-resizable-handle ui-resizable-s'>=</div>"), n += "</" + (r ? "a" : "div") + ">"
        }

        function l(t, e, n) {
            var r = e.find("div.fc-event-time");
            m(t) && d(t, e, r), n.isEnd && b(t) && u(t, e, r), w(t, e)
        }
        ...
        function c(t, n, r) {
            ...
            var o, i, s, l = r.isStart, c = !0, d = S(), u = N(), f = X(), p = W(), m = O(), y = A(), b = Y();
            n.draggable({
                opacity: v("dragOpacity", "month"),
                revertDuration: v("dragRevertDuration"),
                start: function (e, r) {
                    h("eventDragStart", n, t, e, r), P(t, n), o = n.width(), d.start(function (e, r) {
                        if ($(), e) {
                            i = !1;
                            var o = R(0, r.col), d = R(0, e.col);
                            s = d.diff(o, "days"), e.row ? l ? c && (n.width(u - 10), g(n, G.defaultTimedEventDuration / p * m), n.draggable("option", "grid", [u, 1]), c = !1) : i = !0 : (q(t.start.clone().add("days", s), K(t).add("days", s)), a()), i = i || c && !s
                        } else a(), i = !0;
                        n.draggable("option", "revert", i)
                    }, e, "drag")
                },
                stop: function (r, o) {
                    if (d.stop(), $(), h("eventDragStop", n, t, r, o), i)a(), n.css("filter", ""), B(t, n); else {
        ...
        function d(t, e, n) {
            ...
            var o, i, s, l, c, d, u, p, m, g, y, b, w, D = f.getCoordinateGrid(), T = F(), C = N(), E = Y(), S = A();
            e.draggable({
                scroll: !1,
                grid: [C, E],
                axis: 1 == T ? "y" : !1,
                ...
                revertDuration: v("dragRevertDuration"),
                start: function (n, r) {
                    h("eventDragStart", e, t, n, r), P(t, e), D.build(), o = e.position(), i = D.cell(n.pageX, n.pageY), s = l = !0, c = d = x(i), u = p = 0, m = 0, g = y = 0, b = null, w = null
                },
                drag: function (n, a) {
                    ...
                    if (s = !!f) {
                        ...
                        c || (g = Math.round((a.position.top - o.top) / E))
                    }
                    (s != l || c != d || u != p || g != y) && (c ? (b = t.start.clone().stripTime().add("days", m), w = b.clone().add(G.defaultAllDayEventDuration)) : (b = t.start.clone().add(g * S).add("days", m), w = K(t).add(g * S).add("days", m)), r(), l = s, d = c, p = u, y = g), e.draggable("option", "revert", !s)
                },
                stop: function (n, a) {
                    $(), h("eventDragStop", e, t, n, a), s && (c || m || g) ? j(this, t, b, n, a) : (s = !0, c = !1, u = 0, m = 0, g = 0, r(), e.css("filter", ""), e.css(o), B(t, e))
                }
            })
        }
        ...
        function u(t, e, n) {
            ...
            e.resizable({
                handles: {s: ".ui-resizable-handle"}, grid: i, start: function (n, o) {
                    r = a = 0, P(t, e), h("eventResizeStart", this, t, n, o)
                }, resize: function (l, c) {
    ...
    function me(n, r, a) {
        ...
        function u(t, e) {
            Y.push({event: t, element: e}), H[t._id] ? H[t._id].push(e) : H[t._id] = [e]
        }
        ...
        function R(t, e) {
            ...
            for (var l = M(o), c = M(i) - 1, d = 0; n > d; d++) {
                ...
                if (h >= v) {
                    var p = _(v), m = _(h), g = [p.col, m.col].sort(), y = E(v) == o, b = E(h) + 1 == i;
                    a.push({row: d, leftCol: g[0], rightCol: g[1], isStart: y, isEnd: b})
                }
            }
            return a
        }
        ...
        var F = this;
        F.element = n, F.calendar = r, F.name = a, F.opt = o, F.trigger = s, F.isEventDraggable = l, F.isEventResizable = c, F.clearEventData = d, F.reportEventElement = u, F.triggerEventDestroy = f, F.eventElementHandlers = v, F.showEvents = h, F.hideEvents = p, F.eventDrop = g, F.eventResize = y;
        var N = r.reportEventChange, H = {}, Y = [], O = r.options, W = e.duration(O.nextDayThreshold);
        F.isHiddenDay = b, F.skipHiddenDays = D, F.getCellsPerWeek = w, F.dateToCell = k, F.dateToDayOffset = x, F.dayOffsetToCellOffset = M, F.cellOffsetToCell = _, F.cellToDate = T, F.cellToCellOffset = C, F.cellOffsetToDayOffset = E, F.dayOffsetToDate = S, F.rangeToSegments = R;
    ...
    function ge() {
        ...
        function l(t) {
            ...
            var i = H(r, C);
            return e += a ? "<a href='" + _(a) + "'" : "<div", e += " class='" + o.join(" ") + "'" + " style=" + "'" + "position:absolute;" + "left:" + t.left + "px;" + i + "'" + ">" + "<div class='fc-event-inner'>", !r.allDay && t.isStart && (e += "<span class='fc-event-time'>" + _(re(r.start, C("timeFormat"))) + "</span>"), e += "<span class='fc-event-title'>" + _(r.title || "") + "</span>" + "</div>", r.allDay && t.isEnd && k(r) && (e += "<div class='ui-resizable-handle ui-resizable-" + (n ? "w" : "e") + "'>" + "&nbsp;&nbsp;&nbsp;" + "</div>"), e += "</" + (a ? "a" : "div") + ">"
        }
        ...
        function w(t, e) {
            ...
            e.draggable({
                ...
                stop: function (o, i) {
                    a.stop(), $(), E("eventDragStop", e, t, o, i), n ? Y(this, t, r, o, i) : (e.css("filter", ""), R(t, e))
                }
            })
        }
        ...
        function D(e, r, a) {
            ...
            F(r), r.mousedown(function (t) {
                ...
                function s(n) {
                    E("eventResizeStop", this, e, n), t("body").css("cursor", ""), f.stop(), $(), c && A(this, e, d, n), setTimeout(function () {
                        l = !1
                    }, 0)
                }
    ...
    }, _e = t.fullCalendar = {version: "2.0.0"}, Re = _e.views = {};
    t.fn.fullCalendar = function (e) {
        ...
        a || (a = Me[e] = {}), o(a, {
            ...
            defaultButtonText: {prev: R(r.prevText), next: R(r.nextText), today: R(r.currentText)}
    ...
    var Fe = {dataType: "json", cache: !1}, Ne = 1;
    _e.applyAll = Y;
    var He = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], Ye = /^\s*\d{4}-\d\d$/, Ae = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/;
    _e.moment = function () {
        return O(arguments)
    ...
    Re.month = U, Re.basicWeek = G, Re.basicDay = Q, a({weekMode: "fixed"}), Re.agendaWeek = te, Re.agendaDay = ee, a({
        allDaySlot: !0,
        allDayText: "all-day",
        scrollTime: "06:00:00",
