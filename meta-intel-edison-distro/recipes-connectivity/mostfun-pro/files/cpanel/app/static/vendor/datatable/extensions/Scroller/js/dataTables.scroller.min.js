...
(function (j, m, k) {
    var l = function (e) {
        var f = function (a, b) {
            !this instanceof f ? alert("Scroller warning: Scroller must be initialised with the 'new' keyword.") : ("undefined" == typeof b && (b = {}), this.s = {
                dt: a,
                tableTop: 0,
                tableBottom: 0,
                redrawTop: 0,
                ...
                topRowFloat: 0,
                scrollDrawDiff: null
            }, this.s = e.extend(this.s, f.oDefaults, b), this.s.heights.row = this.s.rowHeight, this.dom = {
                force: m.createElement("div"),
                scroller: null, table: null
        ...
        f.prototype = {
            fnRowToPixels: function (a, b, c) {
                ...
                0 > f && (f = 0);
                if ((g > this.s.redrawBottom || g < this.s.redrawTop) && this.s.dt._iDisplayStart !== f)d = !0, g = this.fnRowToPixels(a, !1, !0);
                ...
                if (!this.s.skip)if (this.s.dt.bFiltered || this.s.dt.bSorted)this.s.lastScrollTop =
                    0; else {
                    this._fnInfo();
