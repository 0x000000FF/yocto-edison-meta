...
(function (n, p, q) {
    ...
    $.fn.dataTableExt.oApi.fnColReorder = function (b, e, a) {
        ...
        if (e != a)if (0 > e || e >= j)this.oApi._fnLog(b, 1, "ColReorder 'from' index is out of bounds: " +
        e); else if (0 > a || a >= j)this.oApi._fnLog(b, 1, "ColReorder 'to' index is out of bounds: " + a); else {
            g = [];
            c = 0;
            for (d = j; c < d; c++)g[c] = c;
            i(g, e, a);
