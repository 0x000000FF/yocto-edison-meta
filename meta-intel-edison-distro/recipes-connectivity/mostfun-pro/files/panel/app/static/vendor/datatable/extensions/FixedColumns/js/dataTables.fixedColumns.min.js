        ...
        k.prototype = {
            ...
            fnRecalculateHeight: function (a) {
                ...
                if ("function" != typeof this.s.dt.oInstance.fnVersionCheck || !0 !== this.s.dt.oInstance.fnVersionCheck("1.8.0"))alert("FixedColumns " + k.VERSION + " required DataTables 1.8.0 or later. Please upgrade your DataTables installation"); else if ("" === this.s.dt.oScroll.sX)this.s.dt.oInstance.oApi._fnLog(this.s.dt, 1, "FixedColumns is not needed (no x-scrolling in DataTables enabled), so no action will be taken. Use 'FixedHeader' for column fixing when scrolling is not enabled"); else {
                    ...
                    if (0 <
                        b.s.iLeftColumns)d(b.dom.grid.left.liner).on("mouseover.DTFC touchstart.DTFC", function () {
                        c = "left"
                    }).on("scroll.DTFC", function () {
                ...
                d.each(this.s.dt.aoColumns, function (g, f) {
                    ...
                    if (e.filter(":visible").length) {
                        var h = e.outerWidth();
                        if (0 === a.s.aiOuterWidths.length)var j = d(a.s.dt.nTable).css("border-left-width"), h = h + ("string" === typeof j ? 1 : parseInt(j, 10));
                ...
                for (var c = [], g = [], f = [], e = 0, h = a.length; e < h; e++) {
                    ...
                    for (var i = 0, n = this.s.iTableColumns; i < n; i++)if (-1 !== d.inArray(i, b)) {
                        var l = d.inArray(a[e][i].cell, f);
                        -1 === l ? (l =
                            d(a[e][i].cell).clone(!0, !0)[0], g.push(l), f.push(a[e][i].cell), j.push({
                            cell: l,
                            unique: a[e][i].unique
                        })) : j.push({cell: g[l], unique: a[e][i].unique})
                    }
                    c.push(j)
                }
                return c
                ...
                if (g) {
                    ...
                    i.empty();
                    e = 0;
                    for (h = m.length; e < h; e++)i[0].appendChild(m[e].nTr);
                    ...
                    for (h = m.length; e < h; e++) {
                        j = 0;
                        for (i = m[e].length; j < i; j++)o[e][j].cell.className = m[e][j].cell.className, d("span.DataTables_sort_icon", o[e][j].cell).each(function () {
                ...
                if (0 < this.s.dt.aiDisplay.length) {
                    h =
                        d(">thead>tr", a.body)[0];
                    for (k = 0; k < c.length; k++)n = c[k], l = d(this.s.dt.aoColumns[n].nTh).clone(!0)[0], l.innerHTML = "", i = l.style, i.paddingTop = "0", i.paddingBottom = "0", i.borderTopWidth = "0", i.borderBottomWidth = "0", i.height = 0, i.width = f.s.aiInnerWidths[n] + "px", h.appendChild(l);
                ...
                if (null !== this.s.dt.nTFoot) {
                    if (g) {
                        ...
                        for (h = m.length; e < h; e++) {
                            j = 0;
                            for (i = m[e].length; j < i; j++)b[e][j].cell.className = m[e][j].cell.className
                        }
                    }
