...
(function (t, e) {
    ...
    t.position = {
        ...
        return v = o(_), _[0].preventDefault && (e.at = "left top"), d = v.width, g = v.height, m = v.offset, b = t.extend({}, m), t.each(["my", "at"], function () {
            ...
            var o, h, u = t(this), c = u.outerWidth(), p = u.outerHeight(), f = s(this, "marginLeft"), v = s(this, "marginTop"), T = c + f + s(this, "marginRight") + w.width, C = p + v + s(this, "marginBottom") + w.height, D = t.extend({}, b), k = i(x.my, u.outerWidth(), u.outerHeight());
            "right" === e.my[0] ? D.left -= c : "center" === e.my[0] && (D.left -= c / 2), "bottom" === e.my[1] ? D.top -= p : "center" === e.my[1] && (D.top -= p / 2), D.left += k[0], D.top += k[1], t.support.offsetFractions || (D.left = l(D.left), D.top = l(D.top)), o = {
                marginLeft: f,
                marginTop: v
                ...
                var i = m.left - D.left, s = i + d - c, o = m.top - D.top, n = o + g - p, l = {
                    target: {
                        element: _,
                        left: m.left,
                        top: m.top,
                    ...
                    element: {element: u, left: D.left, top: D.top, width: c, height: p},
...
(function (t) {
    t.widget("ui.draggable", t.ui.mouse, {
        ...
        start: function () {
            ...
            }).left - d.margins.left)), !d.snapElements[u].snapping && (s || n || o || a || p) && d.options.snap.snap && d.options.snap.snap.call(d.element, e, t.extend(d._uiHash(), {snapItem: d.snapElements[u].item})), d.snapElements[u].snapping = s || n || o || a || p)
        }
...
(function (t) {
    ...
    t.widget("ui.droppable", {
        ...
        var n, o, a = (t.positionAbs || t.position.absolute).left, r = (t.positionAbs || t.position.absolute).top, l = a + t.helperProportions.width, h = r + t.helperProportions.height, c = i.offset.left, u = i.offset.top, p = c + i.proportions().width, d = u + i.proportions().height;
        switch (s) {
            case"fit":
                return a >= c && p >= l && r >= u && d >= h;
            case"intersect":
                return a + t.helperProportions.width / 2 > c && p > l - t.helperProportions.width / 2 && r + t.helperProportions.height / 2 > u && d > h - t.helperProportions.height / 2;
            case"pointer":
            ...
            case"touch":
                return (r >= u && d >= r || h >= u && d >= h || u > r && h > d) && (a >= c && p >= a || l >= c && p >= l || c > a && l > p);
            default:
                return !1
        }
    }, t.ui.ddmanager = {
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _create: function () {
            ...
            if (this.element.addClass("ui-resizable"), t.extend(this, {
                    ...
                    ne: ".ui-resizable-ne",
                    nw: ".ui-resizable-nw"
                } : "e,s,se"), this.handles.constructor === String)for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), e = this.handles.split(","), this.handles = {}, i = 0; e.length > i; i++)s = t.trim(e[i]), n = "ui-resizable-" + s, o = t("<div class='ui-resizable-handle " + n + "'></div>"), o.css({zIndex: r.zIndex}), "se" === s && o.addClass("ui-icon ui-icon-gripsmall-diagonal-se"), this.handles[s] = ".ui-resizable-" + s, this.element.append(o);
        ...
        stop: function (e) {
            var i = t(this).data("ui-resizable"), s = i.options, o = i._proportionallyResizeElements, n = o.length && /textarea/i.test(o[0].nodeName), a = n && t.ui.hasScroll(o[0], "left") ? 0 : i.sizeDiff.height, r = n ? 0 : i.sizeDiff.width, l = {
                width: i.size.width - r,
                height: i.size.height - a
            }, h = parseInt(i.element.css("left"), 10) + (i.position.left - i.originalPosition.left) || null, p = parseInt(i.element.css("top"), 10) + (i.position.top - i.originalPosition.top) || null;
        ...
        start: function () {
            ...
            var i, s, o, n, a = t(this).data("ui-resizable"), r = a.options, l = a.containerOffset, h = a.position, p = a._aspectRatio || e.shiftKey, u = {
                top: 0,
                left: 0
        ...
        start: function () {
            ...
            var s = t(this).data("ui-resizable"), o = s.options, n = s.originalSize, a = s.originalPosition, r = {
    ...
    t.widget("ui.selectable", t.ui.mouse, {
        ...
        _mouseDrag: function (e) {
            if (this.dragged = !0, !this.options.disabled) {
                var i, s = this, n = this.options, o = this.opos[0], a = this.opos[1], l = e.pageX, r = e.pageY;
                return o > l && (i = l, l = o, o = i), a > r && (i = r, r = a, a = i), this.helper.css({
                    left: o,
                    top: a,
                    width: l - o,
                    height: r - a
...
(function (t) {
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _intersectsWith: function (t) {
            var e = this.positionAbs.left, i = e + this.helperProportions.width, s = this.positionAbs.top, o = s + this.helperProportions.height, n = t.left, r = n + t.width, a = t.top, h = a + t.height, l = this.offset.click.top, c = this.offset.click.left, p = "x" === this.options.axis || s + l > a && h > s + l, u = "y" === this.options.axis || e + c > n && r > e + c, d = p && u;
            return "pointer" === this.options.tolerance || this.options.forcePointerForContainers || "pointer" !== this.options.tolerance && this.helperProportions[this.floating ? "width" : "height"] > t[this.floating ? "width" : "height"] ? d : e + this.helperProportions.width / 2 > n && r > i - this.helperProportions.width / 2 && s + this.helperProportions.height / 2 > a && h > o - this.helperProportions.height / 2
        },
        ...
        _getItemsAsjQuery: function (e) {
            ...
            var s, o, n, r, a = [], h = [], l = this._connectWith();
            if (l && e)for (s = l.length - 1; s >= 0; s--)for (n = t(l[s]), o = n.length - 1; o >= 0; o--)r = t.data(n[o], this.widgetFullName), r && r !== this && !r.options.disabled && h.push([t.isFunction(r.options.items) ? r.options.items.call(r.element) : t(r.options.items, r.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), r]);
        ...
        _refreshItems: function (e) {
            ...
            var i, s, o, n, r, a, h, l, c = this.items, p = [[t.isFunction(this.options.items) ? this.options.items.call(this.element[0], e, {item: this.currentItem}) : t(this.options.items, this.element), this]], u = this._connectWith();
            if (u && this.ready)for (i = u.length - 1; i >= 0; i--)for (o = t(u[i]), s = o.length - 1; s >= 0; s--)n = t.data(o[s], this.widgetFullName), n && n !== this && !n.options.disabled && (p.push([t.isFunction(n.options.items) ? n.options.items.call(n.element[0], e, {item: this.currentItem}) : t(n.options.items, n.element), n]), this.containers.push(n));
        ...
        _contactContainers: function (s) {
            var o, n, r, a, h, l, c, p, u, d, f = null, g = null;
